...
// });
 ...
 authUser =  function(req,res,next){     
    ...
    // ecncrypting pass
    const encryptedPassword = (crypto.createHash("sha1").update(password, "binary").digest("hex"));
    ...
    if(typeof username=='' || typeof username=='undefined' || typeof password=='' || typeof password=='undefined'){
        ...
        connection.query('select * from user where username = ? AND  password = ? AND isdeleted=0',[username,encryptedPassword],
